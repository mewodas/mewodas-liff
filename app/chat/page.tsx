      ...
      <div className="fixed bottom-14 left-0 right-0 bg-white border-t border-stone-200 px-3 py-2">
        <div className="max-w-md mx-auto flex gap-2 items-end">
          ...
          <button
            ...
            className="bg-emerald-500 text-white font-bold w-10 h-10 rounded-full active:bg-emerald-700 disabled:bg-stone-300 flex items-center justify-center flex-shrink-0"
            aria-label="送信"
          >
            ↑
          </button>
